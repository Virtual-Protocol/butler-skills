#!/usr/bin/env python3
"""build_index.py — build dist/index.json plus immutable per-version skill files.
...
Nothing about a skill's content is stored in this repository; the clones are
deleted when the build ends. The index is the only published description of a
skill — there is no checked-in mirror of it to drift out of date.
