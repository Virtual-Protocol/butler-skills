...
5. [FIXED] Create it — never hand-write the duty's code, the shim loads this
   ...
   ```bash
   bevo-automation create --from-skill butler-copytrade@3.0.0 '<json>'
   ```
